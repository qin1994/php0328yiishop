...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！<?=\yii::$app->user->isGuest?'[<a href="">登录</a>] [<a href="register.html">免费注册</a>]':\yii::$app->user->identity->username ?></li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <div class="cat item1">
                    ...
                    <?php $childs=\backend\models\GoodsCategory::find()->where('parent_id='.$model->id)->all()?>
                    <div class="cat_detail">
                    <?php foreach ($childs as $child): ?>
                        <dl class="dl_1st">
                            <dt><a href="lists?id=<?=$model->id?>"><?=$child->name?></a></dt>
                            <?php $rows = \backend\models\GoodsCategory::find()->where('parent_id='.$child->id)->all()?>
                            <dd>
                        <?php foreach ($rows as $row): ?>
                                <a href="lists?id=<?=$model->id?>"><?=$row->name?></a>
                        <?php endforeach;?>
                            </dd>
                        </dl>
                    <?php endforeach;?>
