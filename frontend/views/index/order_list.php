				...
				<table class="orders">
					...
					<tbody>
						<?php foreach ($orders as $order): ?>
							<?php $order_lists = \frontend\models\OrderGoods::find()->where(['order_id'=>$order->id])->all() ?>
							<?php foreach($order_lists as $order_list): ?>
						<tr>
							<td><a href=""><?= rand(10000000,99999999) ?></a></td>
							<td><a href=""><img src="http://admin.yiishop.com<?= $order_list->logo ?>" alt="" /></a></td>
							<td><?= $order->name ?></td>
